<?php namespace Ttt\Panel\Pagination;
...
class TttPresenter {
    ...
    public function getAdjacentRange()
    {
        ...
        return $this->getPageRange($start, $this->currentPage + 2);
    }
     ...
     * @return string
     */
    public function getPrevious($text = 'Anterior')
    {
     ...
     * @return string
     */
    public function getNext($text = 'Siguiente')
    {
    ...
    {
        return '<li class="light disabled"><a href="#">...</a></li>';
    }
