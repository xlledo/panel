	...
	<div class="row">
	    <div class="col-xs-12 widget-container-span">
			...
			@if(Sentry::getUser()->hasAccess('categorias::editar-arbol'))
				<a href="{{ action('Ttt\Panel\CategoriaController@ordenarAlfabeticamente', $root->id) }}" title="Ordenar alfabéticamente este árbol" class="btn btn-sm btn-primary no-border"><i class="icon-list"></i></a>
			@endif
		</div>
	</div>
@stop
